...
namespace UnoAcpClient.Infrastructure.Tests.Logging;
...
public class LoggingConfigurationTests
{
    ...
    {
        // Arrange
        var tempPath = Path.Combine(Path.GetTempPath(), "UnoAcpClientTests", Guid.NewGuid().ToString());
    ...
    public void GetPlatformSpecificLogPath_ShouldReturnValidPath()
    {
        ...
        Assert.Contains("UnoAcpClient", path);
    }
}
