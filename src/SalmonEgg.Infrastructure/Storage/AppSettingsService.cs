    ...
    public async Task<AppSettings> LoadAsync()
    {
        try
        {
            ...
            return new AppSettings
            {
                ...
                SidebarConversationGrouping = AppSettingValueCatalog.NormalizeSidebarConversationGrouping(model.SidebarConversationGrouping),
                SidebarAttentionGroupExpanded = model.SidebarAttentionGroupExpanded,
                SidebarWorkingGroupExpanded = model.SidebarWorkingGroupExpanded,
                SidebarOtherGroupExpanded = model.SidebarOtherGroupExpanded,
