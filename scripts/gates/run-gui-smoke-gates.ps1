...
Invoke-DotNetTestWithRetry -Method "SalmonEgg.GuiTests.Windows.ChatSkeletonSmokeTests.AuxiliaryPanels_AfterCloseAndReopen_RetainContentInsteadOfBlankSurface"
Invoke-DotNetTestWithRetry -Method "SalmonEgg.GuiTests.Windows.ChatSkeletonSmokeTests.TaskOverviewPanel_WithoutPlanOrChanges_HidesEntry"
